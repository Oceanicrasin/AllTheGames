...
while selected:
  ...
  if duplicated ==17:
    ...
    while True:
      try:
        while playerCorrect:
          pChoice1="1 1 1 2 1 3"#input("Enter the three coordinates of your first ship seperated by a space: \n")
          pChoice2="1 4 1 5 1 6"#input("Enter the three coordinates of your second ship seperated by a space: \n")
          pChoice3="1 7 1 8 1 9"#input("Enter the three coordinates of your third ship seperated by a space: \n")
          pChoice4="2 1 2 2 2 3"#input("Enter the four coordinates of your fourth ship seperated by a space: \n")
          pChoice5="3 1 3 2 3 3 3 4 3 5"#input("Enter the five coordinates of your fifth ship seperated by a space: \n")
